...
std::pair<int, int> resize(int width, int height, int max_w = 50) {
...
std::string PNGtoASCII(unsigned char* data, int original_width, int original_height, int width_art, int height_art) {
    std::string result;
...
std::string remake_console(std::string pixels, double aspect_ratio = 2.5) {
...
int main()
{
    ...
    cout << remake_console(PNGtoASCII(data, wm, hm, w, h), 2.5);
